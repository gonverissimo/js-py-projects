...
function Forum() {
  ...
  <section className="subjects-section">
    <div className="subjects-container">
      {['Português', 'História A', 'Inglês', 'MACS', 'Filosofia', 'Geografia A', 'Matemática A', 'Biologia e Geologia', 'Física e Química'].map((subject) => (
        <div className="subject-box" key={subject}>
          {subject}
        </div>
      ))}
    </div>
